...
(rule (question scuole)
        (answer no)
        (attribute migliore-quartiere)
        (value_attribute crocetta barriera campidoglio foramgno lazzaretto sassi boccea magliana flaminio)
        (cf_value 40 70 30 50 80 50 70 40 60 )
        )

(rule (question supermercati)
        (answer si)
        (attribute migliore-quartiere)
        (value_attribute san_donato vanchiglia campidoglio cenisia centro_storico porta_venezia sassi pilone boccea teastaccio magliana flaminio)
...
(rule (question supermercati)
        (answer no)
        (attribute migliore-quartiere)
        (value_attribute crocetta barriera campidoglio foramgno lazzaretto sassi boccea magliana)
        (cf_value 80 80 40 30 40 80 70 40)
        )
